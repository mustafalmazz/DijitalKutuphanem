...
namespace BookManagementApp.Migrations
{
    ...
    [Migration("20260721031440_AddPackageExpiresAt")]
    partial class AddPackageExpiresAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookManagementApp.Models.ProfileBanner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookManagementApp.Models.UserBanner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookManagementApp.Areas.Admin.Models.User", b =>
                {
                    b.HasOne("BookManagementApp.Models.ProfileBanner", "ActiveBanner")
                        .WithMany()
                        .HasForeignKey("ActiveBannerId");

                    b.HasOne("BookManagementApp.Models.Achievement", "ActiveTitleAchievement")
                        .WithMany()
                        .HasForeignKey("ActiveTitleAchievementId");

                    b.Navigation("ActiveBanner");
            ...
            modelBuilder.Entity("BookManagementApp.Models.UserBanner", b =>
                {
                    b.HasOne("BookManagementApp.Models.ProfileBanner", "ProfileBanner")
                        .WithMany()
