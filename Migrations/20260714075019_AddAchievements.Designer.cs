...
namespace BookManagementApp.Migrations
{
    ...
    [Migration("20260714075019_AddAchievements")]
            ...
            modelBuilder.Entity("BookManagementApp.Models.Achievement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ColorHex = "#4CAF50",
                            Description = "İlk kitabınızı eklediniz.",
                        ...
                        new
                        {
                            Id = 2,
                            ColorHex = "#2196F3",
                            Description = "10 kitap eklediniz.",
                            IconClass = "fa-book",
                            Name = "Kitap Kurdu"
                        },
                        new
                        {
                            Id = 3,
                            ColorHex = "#FF9800",
                            Description = "İlk Odaklanma (Pomodoro) seansınızı tamamladınız.",
